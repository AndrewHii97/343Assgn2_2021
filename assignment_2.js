...
var zAxis = 2;
var axis = 0;
var theta =[45.0, 45.0, 45.0]; // to set the initial rotation of object
...
var NumVertices1  = 12;
var modelViewMatrix_1;
function colorPyramid()
{
    quad1( 12, 13, 14 ); // bottom
    quad1( 12, 14, 15 ); // side0
    quad1( 14, 12, 15 ); // side1
    quad1( 15, 13, 12 ); // side3
}
...
var render = function(){
    ...
    modelView = mult(modelView, translate(3.5,0,0));

    gl.uniformMatrix4fv(modelViewMatrixLoc, false, flatten(modelView));

    gl.drawArrays( gl.TRIANGLES, 0, numVertices+NumVertices1 );
    ...
    for( var i=numVertices+NumVertices1; i<index+numVertices+NumVertices1; i+=3) 
    ...
    modelViewMatrix_1 = mult(modelViewMatrix_1, translate(-3.5,0,0));
